...
[The API schema](working-in-the-code.md#the-api-schema); why this OpenAPI version is
...
- **The QR multi-scan flow.** The reason this project exists: scanning several
  ...
  [`/api/docs`](working-in-the-code.md#the-api-schema). The cart that holds a batch
